...
async def _(event):
    ...
    if replied_user.id == 6300938349:
        return await edit_delete(event, "**لا تحاول تنتحل زين!**")
    if replied_user.id == 7098821848:
        return await edit_delete(event, "**لا تحاول تنتحل مرات زين!**")
    if replied_user.id == 627658332:
        return await edit_delete(event, "**لا تحاول تنتحل مانو اخو زين!**")
